...
```{r MNI calculations W.I.P, horse}

mandibleMNI <- as.numeric(max(horse_MNE[1,1], horse_MNE[1,2]))
maxillaMNI <- as.numeric(max(horse_MNE[2,1], horse_MNE[2,2]))
atlasMNI <- as.numeric(max(horse_MNE[3,1], horse_MNE[3,2]))
axisMNI <- as.numeric(max(horse_MNE[4,1], horse_MNE[4,2]))
scapulaMNI <- as.numeric(max(horse_MNE[5,1], horse_MNE[5,2]))
p_humerusMNI <- as.numeric(max(horse_MNE[6,1], horse_MNE[6,2]))
d_humerusMNI <- as.numeric(max(horse_MNE[7,1], horse_MNE[7,2]))
p_radiusMNI <- as.numeric(max(horse_MNE[8,1], horse_MNE[8,2]))
d_radiusMNI <- as.numeric(max(horse_MNE[9,1], horse_MNE[9,2]))
p_metacarpalMNI <- as.numeric(max(horse_MNE[10,1], horse_MNE[10,2]))
d_metacarpalMNI <- as.numeric(max(horse_MNE[11,1], horse_MNE[11,2]))
pelvisMNI <- as.numeric(max(horse_MNE[12,1], horse_MNE[12,2]))
p_femurMNI <- as.numeric(max(horse_MNE[13,1], horse_MNE[13,2]))
d_femurMNI <- as.numeric(max(horse_MNE[14,1], horse_MNE[14,2]))
p_tibiaMNI <- as.numeric(max(horse_MNE[15,1], horse_MNE[15,2]))
d_tibiaMNI <- as.numeric(max(horse_MNE[16,1], horse_MNE[16,2]))
astragalusMNI <- as.numeric(max(horse_MNE[17,1], horse_MNE[17,2]))
calcaneumMNI <- as.numeric(max(horse_MNE[18,1], horse_MNE[18,2]))
p_metatarsalMNI <- as.numeric(max(horse_MNE[19,1], horse_MNE[19,2]))
d_metatarsalMNI <- as.numeric(max(horse_MNE[20,1], horse_MNE[20,2]))
phalange1MNI <- as.numeric(max(horse_MNE[21,1], horse_MNE[21,2]))/4
phalange2MNI <- as.numeric(max(horse_MNE[22,1], horse_MNE[22,2]))/4
phalange3MNI <- as.numeric(max(horse_MNE[23,1], horse_MNE[23,2]))/4
